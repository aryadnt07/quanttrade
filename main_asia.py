"""
Asian Mean Reversion — Standalone Runner
========================================
Strategi mean-reverting berbasis Z-Score pada sesi Asia (01:00-04:30 UTC)
dengan konfirmasi RSI & filter volatilitas ATR.

Usage:
    python main_asia.py
    python main_asia.py --data data/xauusd-m5-bid-2024-09-08-2026-09-08.csv
    python main_asia.py --no-chart
"""
...
from engine.asia.indicators import compute_all
from engine.asia.backtester import Backtester
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="Path ke file CSV data M5 (default: dataset default config)",
    )
    parser.add_argument(
        "--days", type=int, default=30,
        help="Jumlah hari data sintetis jika --data tidak diberikan",
    )
    parser.add_argument(
...
def main():
    ...
    # ── 1. LOAD DATA ──
    data_path = args.data if args.data else "data/xauusd-m5-bid-2024-09-08-2026-09-08.csv"
