...
======================================================
Memuat dan menyelaraskan data multi-timeframe (M5, M15, H1, H4)
...
def resample_ohlcv(df: pd.DataFrame, rule: str) -> pd.DataFrame:
    """Resample data M5 ke timeframe lebih tinggi (M15, 1h, 4h)."""
...
def compute_htf_indicators(df_htf: pd.DataFrame, tf_name: str) -> pd.DataFrame:
    """Hitung indikator standar pada timeframe HTF (EMA 50, EMA 200, ATR 14, RSI 14)."""
...
def load_mtf_dataset(
    ...
    """Memuat dataset M5 dan memperkayanya dengan indikator HTF secara kausal."""
