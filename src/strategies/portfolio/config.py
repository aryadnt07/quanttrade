...
2. London Pit Opening Range Breakout (M5) — Sesi London (08:15 - 11:30 UTC)
3. New York Opening Range Breakout (M5) — Sesi New York (13:45 - 16:30 UTC)
"""

from src.strategies.asian_mr import config as asian_cfg
...
MAX_LOT                   = 10.0       # Lot maksimum broker
