...
# Impor konstanta kanonikal exit Asia (Fix V5: Single Source of Truth)
from src.strategies.asian_mr.config import (
    Z_EXIT_THRESHOLD as ASIA_Z_EXIT_THRESHOLD,
    Z_HARD_CUT as ASIA_Z_HARD_CUT,
    MAX_TRADE_DURATION_MIN as ASIA_MAX_DURATION_MIN,
)
