...
===============================================
Semua parameter strategi dikumpulkan di satu file untuk kemudahan kalibrasi.
"""

# ─────────────────────────────────────────────
# SESSION TIMING (UTC)
# TIME & SESSION SETTINGS (UTC)
# ─────────────────────────────────────────────
...
SESSION_WARMUP_MINUTES = 0           # Dihapus karena start entry diubah ke 01:00
...
HTF_FILTER_MODE        = "ASYMMETRIC_LONG_ONLY" # "SYMMETRIC" (Long > EMA, Short < EMA) atau "ASYMMETRIC_LONG_ONLY"
