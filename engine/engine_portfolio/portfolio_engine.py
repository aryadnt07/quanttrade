...
from engine.engine_london.london_engine import LondonBacktester, LondonStats
...
class PortfolioStats:
    ...
    # ────────────────────────────────────────────────────────
    # 1. Sharpe Ratio: (Rp - Rf) / sigma_p (Daily excess return annualized, Rf=4.0% US Treasury)
    daily_sharpe_ratio: float = 0.0

    # 2. Expectancy: (W/T * AWR) - (L/T * ALR)
    expectancy_usd: float = 0.0
    expectancy_ratio: float = 0.0

    # 3. Value at Risk (VaR): VaR_alpha = P(Delta P <= -V) = alpha (95% and 99% confidence)
    var_95_pct: float = 0.0
    var_99_pct: float = 0.0
    var_95_usd: float = 0.0
    var_99_usd: float = 0.0

    # 4. Mean Adverse Excursion (MAE): max(P_entry - P_min) / largest unrealized loss
    mean_mae_usd: float = 0.0
    max_mae_usd: float = 0.0
    mean_mfe_usd: float = 0.0
    max_mfe_usd: float = 0.0

    # 5. Conditional Value at Risk (CVaR): CVaR_alpha = E[Loss | Loss >= VaR_alpha] (Expected Shortfall)
    cvar_95_pct: float = 0.0
    cvar_99_pct: float = 0.0
    cvar_95_usd: float = 0.0
    cvar_99_usd: float = 0.0

    # 6. Drawdown: (Peak - Trough) / Peak
    avg_drawdown_pct: float = 0.0

    # 7. Sortino Ratio: (Rp - Rf) / sigma_d (Downside deviation of negative excess returns)
...
class PortfolioEngine:
    ...
    def _compute_portfolio_metrics(self):
        ...
        # ────────────────────────────────────────────────────────
        # 1. PEAK-TO-TROUGH DRAWDOWN CALCULATION
        ...
        # ────────────────────────────────────────────────────────
        # 2. DAILY RETURNS & TIME SERIES NORMALIZATION
        # ────────────────────────────────────────────────────────
        ...
        # ────────────────────────────────────────────────────────
        # 3. SHARPE RATIO: (Rp - Rf) / sigma_p
        # Standard US Treasury 10Y / Cash Yield: Rf = 4.0% p.a.
        # ────────────────────────────────────────────────────────
        rf_ann = 0.04
        ...
        # ────────────────────────────────────────────────────────
        # 5. VALUE AT RISK (VaR): VaR_alpha = P(Delta P <= -V) = alpha
        ...
        # ────────────────────────────────────────────────────────
        # 6. CONDITIONAL VALUE AT RISK (CVaR): E[Loss | Loss >= VaR_alpha]
        # ────────────────────────────────────────────────────────
        ...
        # ────────────────────────────────────────────────────────
        # 7. MEAN ADVERSE EXCURSION (MAE): max(P_entry - P_min)
        # & MEAN FAVORABLE EXCURSION (MFE)
        # ────────────────────────────────────────────────────────
