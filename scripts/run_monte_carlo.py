"""
Quantitative Master Portfolio — Monte Carlo Stress Test Runner
==============================================================
...
Contoh Penggunaan:
    ...
    python scripts/run_monte_carlo.py --iterations 1000 --mode reshuffle
    python scripts/run_monte_carlo.py --iterations 1000 --mode bootstrap
"""
